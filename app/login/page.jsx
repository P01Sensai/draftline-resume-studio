      ...
      <div className="w-full max-w-[1360px] mx-auto min-h-screen flex flex-col lg:flex-row items-stretch justify-center relative z-10">
        ...
        <div className="relative w-full lg:w-[54%] xl:w-[55%] flex flex-col justify-between p-6 sm:p-10 lg:p-12 xl:p-14">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-blue-600 to-indigo-600 flex items-center justify-center text-white shadow-md shadow-blue-600/25">
                <span className="material-symbols-outlined text-2xl font-bold">description</span>
              </div>
              <div className="flex flex-col">
                <span className="font-headline-lg text-headline-lg tracking-tight text-slate-900 font-bold flex items-center gap-2">
                  Draftline
                  <span className="font-caption text-caption px-2.5 py-0.5 rounded-full bg-blue-100 text-blue-700 uppercase font-semibold tracking-wider border border-blue-200">AI Resume Studio</span>
                </span>
              </div>
            </Link>
            <div className="hidden sm:flex items-center gap-1.5 text-slate-600 font-label-sm text-label-sm px-3 py-1 rounded-full bg-white/85 border border-slate-200 shadow-sm backdrop-blur-sm">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
              <span className="font-medium text-slate-700">Draftline AI Engine Active</span>
            </div>
          </div>
          ...
          <div className="relative z-10 my-8 lg:my-auto flex flex-col gap-6">
            <div className="max-w-xl">
              <h1 className="font-display-lg text-display-lg-mobile lg:text-display-lg text-slate-900 font-bold tracking-tight leading-tight">
              ...
              <p className="mt-4 font-body-lg text-body-lg text-slate-600 max-w-lg leading-relaxed">
              ...
              <div className="absolute -top-7 left-1 z-40 flex items-center gap-2">
                {[0, 1, 2].map((idx) => (
                  <button 
                    ...
                    className={`h-1.5 rounded-full transition-all duration-500 ease-out ${activeCardIndex === idx ? 'bg-blue-600 w-6' : 'bg-slate-300 hover:bg-slate-400 w-2'}`}
                  ></button>
                ))}
              </div>

              {/* CARD 1: Pramanshu Prajapati */}
              <div onClick={cycleDeck} className={`card-stack-item ${getCardClass(0)} absolute top-0 left-0 w-[92%] sm:w-[88%] rounded-2xl bg-white border border-slate-200/90 p-5 sm:p-6 cursor-pointer hover:border-blue-300 transition-all`}>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      <h3 className="font-title-sm text-title-sm text-slate-900 font-semibold flex items-center gap-1.5">
                        Pramanshu Prajapati
                        <span className="material-symbols-outlined text-blue-600 text-base" style={{fontVariationSettings: "'FILL' 1"}}>verified</span>
                      </h3>
                      <p className="font-label-sm text-label-sm text-slate-500">Lead UI/UX Designer • Orai</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-blue-700 font-label-sm text-label-sm font-semibold border border-blue-200">
                ...
                <div className="mt-4 p-3 rounded-lg bg-slate-50 border border-slate-200/80">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-semibold text-slate-900">Principal UX & Product Designer</span>
                    <span className="font-caption text-caption text-slate-500 font-medium">2020 — Present</span>
                  </div>
                  <p className="mt-1 font-body-sm text-body-sm text-slate-600 line-clamp-1">
                    Veloce Systems • Built scalable enterprise design systems & frictionless multi-platform design interactions.
                  </p>
                </div>
                <div className="mt-4 space-y-2">
                  <div>
                    <div className="flex justify-between font-caption text-caption text-slate-600 mb-1">
                  ...
                  <div>
                    <div className="flex justify-between font-caption text-caption text-slate-600 mb-1">
                      ...
                      <span className="text-indigo-600 font-semibold">97%</span>
                    </div>
                    <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden">
                ...
                <div className="absolute -bottom-4 right-4 sm:-right-4 px-3.5 py-2 rounded-xl bg-white text-slate-800 shadow-xl flex items-center gap-2.5 text-xs border border-slate-200">
                  <span className="flex h-5 w-5 rounded-full bg-amber-50 border border-amber-200 items-center justify-center text-amber-600 text-xs font-bold">⚡</span>
                  <div>
                    <p className="font-semibold text-[11px] text-amber-700">Portfolio Match Verified</p>
                    <p className="text-[10px] text-slate-500">Keywords matched design rubric</p>
                  </div>
                </div>
                <div className="absolute -top-3.5 -left-3 sm:-left-5 px-3 py-1.5 rounded-lg bg-white text-slate-800 shadow-xl flex items-center gap-2 text-xs border border-slate-200">
                  <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                  <span className="font-label-sm text-label-sm font-medium text-slate-700">Google Recruiter contacted Pramanshu</span>
                </div>
              </div>

              {/* CARD 2: Aditya Bhardwaj */}
              <div onClick={cycleDeck} className={`card-stack-item ${getCardClass(1)} absolute top-0 left-0 w-[92%] sm:w-[88%] rounded-2xl bg-white border border-slate-200/90 p-5 sm:p-6 cursor-pointer hover:border-blue-300 transition-all`}>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="font-label-sm text-label-sm text-slate-500">Senior Full-Stack Engineer • Gurgaon</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 font-label-sm text-label-sm font-semibold border border-emerald-200">
                    <span className="material-symbols-outlined text-sm">bolt</span>
                ...
                <div className="mt-4 p-3 rounded-lg bg-slate-50 border border-slate-200/80">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-semibold text-slate-900">Staff Full-Stack & Core Systems</span>
                    <span className="font-caption text-caption text-slate-500 font-medium">2021 — Present</span>
                  </div>
                  <p className="mt-1 font-body-sm text-body-sm text-slate-600 line-clamp-1">
                ...
                <div className="absolute -bottom-4 right-4 sm:-right-4 px-3.5 py-2 rounded-xl bg-white text-slate-800 shadow-xl flex items-center gap-2.5 text-xs border border-slate-200">
                  <span className="flex h-5 w-5 rounded-full bg-blue-50 border border-blue-200 items-center justify-center text-blue-600 text-xs font-bold">✦</span>
                  <div>
                    <p className="font-semibold text-[11px] text-blue-700">AI Action Verb Applied</p>
                    <p className="text-[10px] text-slate-500">+16% readability boost</p>
                  </div>
                </div>
                <div className="absolute -top-3.5 -left-3 sm:-left-5 px-3 py-1.5 rounded-lg bg-white text-slate-800 shadow-xl flex items-center gap-2 text-xs border border-slate-200">
                  <span className="w-2 h-2 rounded-full bg-emerald-500"></span>
                  <span className="font-label-sm text-label-sm font-medium text-slate-700">Stripe invited Aditya to interview</span>
                </div>
              </div>

              {/* CARD 3: Sophia Patel */}
              <div onClick={cycleDeck} className={`card-stack-item ${getCardClass(2)} absolute top-0 left-0 w-[92%] sm:w-[88%] rounded-2xl bg-white border border-slate-200/90 p-5 sm:p-6 cursor-pointer hover:border-blue-300 transition-all`}>
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3.5">
                    ...
                    <div>
                      ...
                      <p className="font-label-sm text-label-sm text-slate-500">Principal Product Manager • Bangalore</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-emerald-50 text-emerald-700 font-label-sm text-label-sm font-semibold border border-emerald-200">
                    <span className="material-symbols-outlined text-sm">bolt</span>
                ...
                <div className="mt-4 p-3 rounded-lg bg-slate-50 border border-slate-200/80">
                  <div className="flex justify-between items-center text-xs">
                    <span className="font-semibold text-slate-900">Director of Product & AI Systems</span>
                    <span className="font-caption text-caption text-slate-500 font-medium">2022 — Present</span>
                  </div>
                  <p className="mt-1 font-body-sm text-body-sm text-slate-600 line-clamp-1">
                ...
                <div className="absolute -bottom-4 right-4 sm:-right-4 px-3.5 py-2 rounded-xl bg-white text-slate-800 shadow-xl flex items-center gap-2.5 text-xs border border-slate-200">
                  <span className="flex h-5 w-5 rounded-full bg-purple-50 border border-purple-200 items-center justify-center text-purple-600 text-xs font-bold">★</span>
                  <div>
                    <p className="font-semibold text-[11px] text-purple-700">Enterprise Interview Callback</p>
                    <p className="text-[10px] text-slate-500">Role matched: Staff Product Lead</p>
                  </div>
                </div>
                <div className="absolute -top-3.5 -left-3 sm:-left-5 px-3 py-1.5 rounded-lg bg-white text-slate-800 shadow-xl flex items-center gap-2 text-xs border border-slate-200">
                  <span className="w-2 h-2 rounded-full bg-blue-600"></span>
                  <span className="font-label-sm text-label-sm font-medium text-slate-700">98% match for Tier-1 Tech Companies</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="relative w-full lg:w-[46%] xl:w-[45%] flex flex-col justify-center items-center p-6 sm:p-10 lg:p-12 xl:p-14">
          ...
          <div className="relative z-10 w-full max-w-[440px]">
            ...
            <div className="mb-6 p-1 rounded-xl bg-slate-200/70 border border-slate-300/60 flex items-center">
              <button 
            ...
            <div className="rounded-2xl bg-white border border-slate-200/90 p-6 sm:p-8 shadow-xl min-h-[580px]">
              <div className="mb-6 text-left">
                ...
                <p className="mt-1.5 font-body-md text-body-md text-slate-500">
              ...
              <button 
                ...
                type="button" 
                className="w-full py-2.5 px-4 rounded-lg bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 font-label-md text-label-md font-medium flex items-center justify-center gap-3 transition-all duration-200 shadow-sm active:scale-[0.99] group"
              >
              ...
              <div className="relative my-5 flex items-center justify-center">
                ...
                <span className="absolute px-3 bg-white font-caption text-caption text-slate-500 uppercase tracking-wider">
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  <label className="block font-label-sm text-label-sm text-slate-700 font-medium">Email Address</label>
                  <div className="relative rounded-lg border border-slate-200 bg-white focus-within:border-blue-600 focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative rounded-lg border border-slate-200 bg-white focus-within:border-blue-600 focus-within:ring-2 focus-within:ring-blue-100 transition-all">
                    ...
                    <input 
                      ...
                      required
                      className="w-full bg-transparent pl-10 pr-10 py-2.5 rounded-lg text-slate-900 font-body-md text-body-md placeholder:text-slate-400 focus:outline-none" 
                      placeholder="••••••••••••" 
                    />
                    <button 
                      type="button"
              ...
              <p className="mt-4 text-center font-caption text-caption text-slate-500">
                By continuing, you agree to Draftline's <a href="#" className="underline hover:text-slate-800 transition-colors">Terms of Service</a> and <a href="#" className="underline hover:text-slate-800 transition-colors">Privacy Policy</a>.
              </p>
            </div>
